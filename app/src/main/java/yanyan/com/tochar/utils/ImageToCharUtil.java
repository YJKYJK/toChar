...
public class ImageToCharUtil {
     ...
     * @return
     */
    public static Bitmap createAsciiPicColor(Bitmap img, Context context) {
...
//        canvas.drawColor(Color.TRANSPARENT, PorterDuff.Mode.CLEAR);//绘制透明色
     ...
     * @return
     */
    public static Bitmap createAsciiPic(final Bitmap img, Context context) {
       // final String base = "#8XOHLTI)i=+;:,.";// 字符串由复杂到简单
      final String base = "#,.0123456789:;@ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";// 字符串由复杂到简单
        StringBuilder text = new StringBuilder();
        WindowManager wm = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
